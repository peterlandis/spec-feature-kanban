...
| CORE-020 | Rotating 3D knowledge graph | 3D perspective mode inside the Graph tab. Auto-rotates; grab a feature to stop and inspect. Same zoom as CORE-019. Choose 2D or 3D on the Graph page | v1 | ✅ Complete | @peterlandis | specifications/plans/CORE-020-GRAPH-3D-PERSPECTIVE-INTENT.md | Tasks: specifications/tasks/CORE-020-IMPLEMENTATION-TASKS.md. Depends on CORE-017. 2D/3D switch on Graph. Selection card + related-edge highlight. · PR: https://github.com/peterlandis/spec-feature-kanban/pull/4 |
...
| CORE-022 | Readable 3D graph labels | Stop the CORE-020 3D graph from stacking every feature ID and title on top of each other so a large board stays readable | v1 | 🔨 WorkInProgress | @peterlandis | specifications/plans/CORE-022-READABLE-3D-GRAPH-LABELS-INTENT.md | Tasks: specifications/tasks/CORE-022-IMPLEMENTATION-TASKS.md. Depends on CORE-020. Labels only for near/hover/selected nodes. Branch: feat/core-022. · PR: https://github.com/peterlandis/spec-feature-kanban/pull/7 |
