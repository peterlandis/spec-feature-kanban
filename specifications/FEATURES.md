...
| CORE-028 | Graph category clusters and dependency suggestions | Show category groupings as visual clusters on the Graph (not only sparse same-category edges), recognize project feature IDs beyond CORE/AGENT, and suggest Depends-on links you can apply so related work is visible and prioritizable | v1 | 🔨 WorkInProgress | @cursor | specifications/plans/CORE-028-GRAPH-CLUSTERS-DEPENDENCY-SUGGESTIONS-INTENT.md | Tasks: specifications/tasks/CORE-028-IMPLEMENTATION-TASKS.md. Depends on CORE-017. Branch: feat/core-028. · PR: https://github.com/peterlandis/spec-feature-kanban/pull/12 |
