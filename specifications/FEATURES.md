...
| CORE-024 | 3D graph titles and default mode | Show feature titles (not only IDs) on the 3D knowledge graph, and open Graph in 3D by default | v1 | 🔨 WorkInProgress | @cursor | specifications/plans/CORE-024-3D-TITLES-DEFAULT-INTENT.md | Tasks: specifications/tasks/CORE-024-IMPLEMENTATION-TASKS.md. Depends on CORE-020/022. Branch: feat/core-024. |
