...
| CORE-030 | Suggested focus (where to start) | Show a Board strip with Start here and Next features ranked from graph deps and human gates, reuse the same ranking for Jarvis “what next,” and deepen by focusing the pick on Graph | v1 | 🔨 WorkInProgress | @cursor | specifications/plans/CORE-030-SUGGESTED-FOCUS-INTENT.md | Tasks: specifications/tasks/CORE-030-IMPLEMENTATION-TASKS.md. Depends on CORE-017/018/029. Branch: feat/core-030. · PR: https://github.com/peterlandis/spec-feature-kanban/pull/14 |
