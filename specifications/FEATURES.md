...
| CORE-032 | Auto-inflate specifications layout | When opening or creating a project FEATURES.md for the first time, create the missing spec-driven folder structure (plans/tasks/reviews/completions/templates) and template files if they are absent, so agents can plan without a manual inflate skill | v1 | 🔨 WorkInProgress | @cursor | specifications/plans/CORE-032-AUTO-INFLATE-SPECS-INTENT.md | Tasks: specifications/tasks/CORE-032-IMPLEMENTATION-TASKS.md. Depends on CORE-006. Branch: feat/core-032. |
