...
| CORE-031 | Phased overnight feature runner | On Process, build a phased plan from Suggested focus and Run phase to sequentially plan (and optionally implement with batch plan auto-approve) each feature with artifacts committed to git, so you can wake up and review a finished phase. Board stays drag-and-drop only | v1 | 🔨 WorkInProgress | @cursor | specifications/plans/CORE-031-PHASED-OVERNIGHT-RUNNER-INTENT.md | Tasks: specifications/tasks/CORE-031-IMPLEMENTATION-TASKS.md. Depends on AGENT-001 / CORE-030. Branch: feat/core-031. · PR: https://github.com/peterlandis/spec-feature-kanban/pull/15 |
