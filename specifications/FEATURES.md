...
| CORE-025 | Per-feature Cursor model | Choose which Cursor model to use when starting planning, revision, or implementation for a feature, instead of only the global Settings default | v1 | 🔨 WorkInProgress | @cursor | specifications/plans/CORE-025-PER-FEATURE-CURSOR-MODEL-INTENT.md | Tasks: specifications/tasks/CORE-025-IMPLEMENTATION-TASKS.md. Depends on AGENT-001 / CORE-008. Branch: feat/core-025. |
