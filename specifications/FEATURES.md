...
| CORE-029 | Graph related-features roster | When you highlight a feature on 2D (or pin one on 3D), show a left-hand Related list with id, title, short description, and relation—same readable detail in both modes—while 3D keeps In view while spinning | v1 | 🔨 WorkInProgress | @cursor | specifications/plans/CORE-029-2D-RELATED-ROSTER-INTENT.md | Tasks: specifications/tasks/CORE-029-IMPLEMENTATION-TASKS.md. Depends on CORE-017/027. Branch: feat/core-029. · PR: https://github.com/peterlandis/spec-feature-kanban/pull/13 |
