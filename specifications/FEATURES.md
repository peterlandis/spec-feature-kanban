...
| CORE-021 | Quiet missing-branch git checks | Stop `git rev-parse` from printing `fatal: Needed a single revision` when CORE-016 looks up a feature branch that does not exist yet | v1 | 🧪 Testing | @peterlandis | specifications/plans/CORE-021-QUIET-GIT-BRANCH-CHECKS-INTENT.md | Tasks: specifications/tasks/CORE-021-IMPLEMENTATION-TASKS.md. Branch: feat/core-021. |
