...
This directory is the repo-native workflow for Cursor agents. v1 of this project
runs the Kanban locally and fires agents via the Cursor SDK. Agents must start
